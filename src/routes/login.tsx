        ...
        <div className="flex items-center justify-center px-6 py-12 sm:px-10 lg:px-14">
          <div className="w-full max-w-[510px]">
            ...
            >
              ...
              <Button
                type="submit"
                className="h-[54px] w-full rounded-lg bg-[#0828ff] text-base font-semibold text-white shadow-[0_12px_25px_rgba(8,40,255,0.25)] transition-colors hover:bg-[#001bd1]"
              >
                Sign In
              </Button>
            </form>

            <div className="my-9 flex items-center gap-6 text-sm font-medium text-[#26355f]">
            ...
            <p className="mt-9 text-center text-sm font-medium text-[#26355f]">
              Don&apos;t have an account?{" "}
              <button type="button" className="font-semibold text-[#073cff] hover:underline">
                Contact your admin
              </button>
            </p>
          </div>
